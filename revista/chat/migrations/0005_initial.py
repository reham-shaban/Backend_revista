# Generated by Django 4.2.3 on 2023-07-22 21:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('chat', '0004_remove_message_author_remove_message_chat_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('voice_record', 'Voice Record'), ('image', 'Image'), ('text', 'Text')], max_length=20)),
                ...
                ('reaction', models.IntegerField(blank=True, choices=[(6, 'angry'), (2, 'love'), (4, 'wow'), (1, 'like'), (3, 'haha'), (5, 'sad')], null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
